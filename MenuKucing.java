 ...
 */
public class MenuKucing extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(MenuKucing.class.getName());

    /**
     * Creates new form MenuKucing
     */
    public MenuKucing() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jButton1.setText("Data Kucing");
        jButton1.addActionListener(this::jButton1ActionPerformed);

        jButton2.setText("Update Kesehatan");
        jButton2.addActionListener(this::jButton2ActionPerformed);

        jButton3.setText("Info Kucing");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new MenuKucing().setVisible(true));
    }
